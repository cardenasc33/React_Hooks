...
var ModalRoot = memo(function (_a) {
    var modals = _a.modals, _b = _a.container, Container = _b === void 0 ? React.Fragment : _b;
    var _c = useState(undefined), mountNode = _c[0], setMountNode = _c[1];
    // This effect will not be ran in the server environment
    useEffect(function () { return setMountNode(document.body); });
    return mountNode ? ReactDOM.createPortal(React.createElement(Container, null, Object.keys(modals).map(function (key) {
...
var ModalProvider = function (_a) {
    ...
    var contextValue = useMemo(function () { return ({ showModal: showModal, hideModal: hideModal }); }, []);
    return (React.createElement(ModalContext.Provider, { value: contextValue },
        React.createElement(React.Fragment, null,
            children,
            React.createElement(ModalRoot, { modals: modals, container: container }))));
};
...
var useModal = function (component, inputs) {
    ...
    var modal = useMemo(function () { return component; }, inputs);
    var context = useContext(ModalContext);
    var _a = useState(false), isShown = _a[0], setShown = _a[1];
    var showModal = useCallback(function () { return setShown(true); }, []);
    var hideModal = useCallback(function () { return setShown(false); }, []);
    useEffect(function () {
        if (isShown) {
...
export { ModalContext, ModalProvider, ModalRoot, useModal };
